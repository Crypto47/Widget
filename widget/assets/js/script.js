$(document).ready(function() {
    ...
    var mybot = '<div class="chatCont" id="chatCont">'+
                                '<div class="bot_profile">'+
                                    '<img src="https://crypto47.github.io/Widget/widget/assets/img/bot2.svg" class="bot_p_img">'+
                                    '<div class="close">'+
                            ...
                            '<div class="profile_div">'+
                                '<div class="row">'+
                                    '<div class="col-hgt">'+
                                        '<img src="https://crypto47.github.io/Widget/widget/assets/img/bot2.svg" class="img-circle img-profile">'+
                                    '</div><!--col-hgt end-->'+
                                    '<div class="col-hgt">'+
                                        '<div class="chat-txt">'+
                                            'Chat with us now!'+
